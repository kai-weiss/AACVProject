...
class BaseValidator:
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None, custom_predictions=None):
        ...
        # modified
        print("initialized custom preds")
    ...
    def __call__(self, trainer=None, model=None):
        ...
        for batch_i, batch in enumerate(bar):
            ...
            with dt[1]:
                #modified
                print("using custom predictions")
                print("batch_i", batch_i)
                if self.custom_predictions:
                    # print("self.custom_predictions[batch_i]: ", self.custom_predictions[batch_i])
                    preds = self.custom_predictions[batch_i]
